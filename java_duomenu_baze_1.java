...
public class java_duomenu_baze_1 {
	...
	public static void main(String[] args) {
		...
		try{
			...
			System.out.println ( "----------------------------------------------------------------------------------------------------------------" );
			System.out.println ( "| id |  menuo  | id_prekes | id_prekiu_grupes | kiekis_gauta |  suma_gauta  | kiekis_parduota | suma_parduota |" );
			System.out.println ( "----------------------------------------------------------------------------------------------------------------" );
			...
			while ( rs.next() ) {
				...
				System.out.println ( 
					...
					String.format (
						...
						"| %2d | %7d | %9d | %16d | %12d | %12.2f | %15d | %13.2f |"
						, id 
						, menuo
						, id_prekes
						, id_prekiu_grupes
